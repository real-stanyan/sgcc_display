      ...
      <tbody>
        ...
        <tr>
          ...
          <td className="border border-gray-300 text-left p-2">
            <ul className="space-y-2">
              <li>
                1.
                全量参与班组所辖电缆线路相关的可研、初设、施工图等方案的评审。
              </li>
              <li>
                2.全量开展班组所辖线路的全量新建220kV电缆线路（含改、扩建）的附件制作关键环节安装旁站、110kV电缆线路（含改、扩建）的首件附件制作关键环节安装旁站、通道及本体验收、技术资料审核、归档等工作。
              </li>
              <li>
                3.开展班组所辖范围内电缆设备终端头制作、附件安装、部分电缆更换、接地箱修复或更换、交叉互联箱修复或更换等工作，自主实施比例不低于所辖范围内业务总量的30%。
              </li>
              <li>
                4.自主开展班组所辖范围内电缆线路红外检测、接地环流检测、局放检测等例行试验，自主实施比例不低于所辖范围内业务总量的30%。
              </li>
              <li>
                5.开展设备消缺及故障处理标准化作业（方案-组织-消缺-资料归档），自主实施比例不低于对应类型检修工作要求；
              </li>
              <li>
                6.开展隐患排查方案编制；自主开展班组所辖设备设施隐患排查和管控措施落实；按要求定期自主实施设备本体、通道巡视等工作。
              </li>
              <li>
                7.自主完成抢修方案编制，组织（模拟）开展故障探寻、通道隐患处置等事故处置等工作，自主实施比例不低于对应类型检修运维工作要求。
              </li>
              <li>
                8.全量自主开展设备状态评价、工作计划编制、工器具日常管理、台账资料整理等日常工作。
                有关说明：电缆主绝缘绝缘电阻测量等C、D类检修工作，除电缆铭牌安装、辅助巡视、电缆通道清理、电缆敷设、特种车辆操作、土建施工、隐患值守等可全量或部分外包的业务外，均应计入业务实施总量。
              </li>
            </ul>
          </td>
          <td className="border border-gray-300 text-center">
        ...
        <tr>
          <td className="border border-gray-300 text-left p-2">
            <ul className="space-y-2">
              <li>
                1.开展班组所辖范围内电缆设备终端头制作、附件安装、部分电缆更换、接地箱修复或更换、交叉互联箱修复或更换等工作，自主实施比例不低于所辖范围内业务总量的30%，每增加5%加1分。
              </li>
              <li>
                2.开展班组所辖范围内电缆线路红外检测、接地环流检测、局放检测等例行试验，自主实施比例不低于所辖范围内业务总量的30%，每增加5%加1分。
                有关说明：以上单项加分不超过5分，总加分不超过10分。
              </li>
            </ul>
          </td>
          <td className="border border-gray-300 text-center">
        ...
        <tr>
          ...
          <td className="border border-gray-300 text-left p-2">
            标杆班组员工能力覆盖率应达80%以上（能力覆盖率：标杆班组员工具备能力总数/(标杆班组总人数*业务类型)（不含当年入职的新员工），2年内自主实施该类型业务3次及以上，则认为具备此类型业务能力）。
          </td>
          <td className="border border-gray-300 text-center">
            自主举证，现场核查
          </td>
