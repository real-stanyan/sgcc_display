  ...
  <div className="overflow-x-auto w-full">
    ...
    <table className="table-auto w-full border-collapse border border-gray-300">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td className="border border-gray-300 text-left p-2">
            <ul className="space-y-2">
              <li>
                1.全量参与班组所辖线路相关的可研、初设、施工图等方案的评审，能够独立完成相关专业技术要点核准、反措要求落实、专业意见编制等工作。
              </li>
              <li>
                2.全量开展班组所辖区域新建输电线（含改、扩建）的关键环节安装旁站、重要跨越段设备检测、通道及本体验收、技术资料审核、归档等工作。
              </li>
              <li>
                3.自主开展班组所辖范围内无人机巡检、红外测温、盐灰密测零、接地电阻检测、少量绝缘子更换、间隔棒等金具零星更换等工作，自主实施比例不低于所辖范围内业务总量的10%。
                有关说明：除登杆、走线等辅助性验收作业、杆号牌、标识牌及警示牌安装作业、通道辅助巡视、高空及地面辅助性工作、特种车辆操作、土建施工、隐患值守等业务等可部分外包的业务外，均应计入业务实施总量。
              </li>
              <li>
                4.开展班组所辖线路设备消缺及故障处理标准化作业（方案-组织-消缺-资料归档），自主实施比例不低于对应类型检修工作要求。
              </li>
              <li>
                5.开展隐患排查方案编制；自主开展班组所辖设备设施隐患排查和管控措施落实；按要求定期自主实施设备本体、通道巡视等工作。
              </li>
              <li>
                6.自主完成抢修方案编制，组织（模拟）开展挂线异物处置、导地线断股修复、通道隐患处置等事故处置等工作，自主实施比例不低于对应类型检修运维工作要求。
              </li>
              <li>
        ...
        <tr>
          <td className="border border-gray-300 text-left p-2">
            开展班组所辖范围内无人机巡检、红外测温、盐灰密测零、接地电阻检测、少量绝缘子更换、间隔棒等金具零星更换等工作，自主实施比例不低于所辖范围内业务总量的10%，每增加5%加1分，不超过10分。
          </td>
