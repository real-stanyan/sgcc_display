...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("border-b-2 border-white", className)}
      {...props}
    />
  );
}
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex justify-around items-center">
      ...
      >
        ...
        <ChevronDownIcon
          className={`
            text-white pointer-events-none size-7 shrink-0 translate-y-0.5 
